...
model.save('Cat_Dog_Balance_12_1') #Salva il modello creato per poterlo utilizzare quando si ha necessità
# Creazione del json e del file rappresentativi del modello per poterlo riprendere senza effettuare ogni volta il fit
model_json = model.to_json()
with open("../Model_12_1/model.json","w") as json_file:
  json_file.write(model_json)

model.save_weights("../Model_12_1/model.h5")
